...
uint8_t FDataBuff[(0x200)], RemainingPackets, tries;
...
void LoadBootConfig(void)
{
 ...
 ReadFMCDataBuffer((uint8_t*)&BootConfig, 0x00100000UL +0x400UL, Fsize);

 if(BootConfig.DefValue != 0x5A3A)
 {
  BootConfig.DefValue = 0x5A3A;
  goto savereturn;
 }

 BootConfig.BootCode = 0x15;

 if(BootConfig.UpdateREQCode == 0xA5A3)
 {
  FlashNewApp();
 }
 ...
 EraseFMCData(0x00100000UL +0x400UL,Fsize);
 WriteFMCData((uint8_t*)&BootConfig, 0x00100000UL +0x400UL, Fsize );
 (((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->ISPCTL &= ~(0x1ul << (5)));
 return;
}
...
void FlashNewApp(void)
{
 ...
 for(CurrentPacket=0;CurrentPacket < Appsize; CurrentPacket+= (0x200))
 {
  ADDR = 0x14000UL;
  ADDR += (CurrentPacket);
