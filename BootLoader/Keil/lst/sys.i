...
# 12 "../../Library/StdDriver/src/sys.c"
...
# 13 "../../Library/StdDriver/src/sys.c" 2
# 40 "../../Library/StdDriver/src/sys.c"
void SYS_ClearResetSrc(uint32_t u32Src)
{
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->RSTSTS = u32Src;
}
# 52 "../../Library/StdDriver/src/sys.c"
uint32_t SYS_GetBODStatus(void)
{
    return ((((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->BODCTL & (0x1ul << (6))) >> (6));
}
...
uint32_t SYS_GetResetSrc(void)
{
    return (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->RSTSTS);
}
# 75 "../../Library/StdDriver/src/sys.c"
uint32_t SYS_IsRegLocked(void)
{
    return !(((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->REGLCTL & 0x1);
}
...
uint32_t SYS_ReadPDID(void)
{
    return ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->PDID;
}
# 98 "../../Library/StdDriver/src/sys.c"
void SYS_ResetChip(void)
{
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->IPRST0 |= (0x1ul << (0));
}
# 110 "../../Library/StdDriver/src/sys.c"
void SYS_ResetCPU(void)
{
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->IPRST0 |= (0x1ul << (1));
}
# 151 "../../Library/StdDriver/src/sys.c"
void SYS_ResetModule(uint32_t u32ModuleIndex)
{

    *(volatile uint32_t *)((uint32_t)&((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->IPRST0 + (u32ModuleIndex >> 24)) |= 1 << (u32ModuleIndex & 0x00ffffff);


    *(volatile uint32_t *)((uint32_t)&((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->IPRST0 + (u32ModuleIndex >> 24)) &= ~(1 << (u32ModuleIndex & 0x00ffffff));
}
# 173 "../../Library/StdDriver/src/sys.c"
void SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{

    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->BODCTL |= (0x1ul << (0));


    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->BODCTL = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->BODCTL & ~(0x1ul << (3))) | i32Mode;


    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->BODCTL = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->BODCTL & ~(0x1ul << (16))) | u32BODLevel;
}
# 192 "../../Library/StdDriver/src/sys.c"
void SYS_DisableBOD(void)
{
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->BODCTL &= ~(0x1ul << (0));
}
