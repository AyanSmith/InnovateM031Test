...
# 85 "../../Library/StdDriver/src/uart.c"
void UART_Close(UART_T *uart)
{
    uart->INTEN = 0ul;
}
# 100 "../../Library/StdDriver/src/uart.c"
void UART_DisableFlowCtrl(UART_T *uart)
{
    uart->INTEN &= ~((0x1ul << (12)) | (0x1ul << (13)));
}
# 124 "../../Library/StdDriver/src/uart.c"
void UART_DisableInt(UART_T *uart, uint32_t u32InterruptFlag)
{
...
# 141 "../../Library/StdDriver/src/uart.c"
void UART_EnableFlowCtrl(UART_T *uart)
{
...
# 172 "../../Library/StdDriver/src/uart.c"
void UART_EnableInt(UART_T *uart, uint32_t u32InterruptFlag)
{
...
void UART_Open(UART_T *uart, uint32_t u32baudrate)
{
    ...
    else if(uart==(UART_T*)((UART_T *) ((( uint32_t)0x40000000) + 0x73000)))
    {

        u32UartClkSrcSel = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL3 & (0x7ul << (28))) >> (28);

        u32UartClkDivNum = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKDIV4 & (0xful << (4))) >> (4);
    }
    else if(uart==(UART_T*)((UART_T *) ((( uint32_t)0x40000000) + 0x74000)))
    {

        u32UartClkSrcSel = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL3 & (0x7ul << (16))) >> (16);

        u32UartClkDivNum = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKDIV4 & (0xful << (8))) >> (8);
    }
    else if(uart==(UART_T*)((UART_T *) ((( uint32_t)0x40000000) + 0x75000)))
    {

        u32UartClkSrcSel = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL3 & (0x7ul << (20))) >> (20);

        u32UartClkDivNum = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKDIV4 & (0xful << (12))) >> (12);
    }
    else if(uart==(UART_T*)((UART_T *) ((( uint32_t)0x40000000) + 0x76000)))
    {

        u32UartClkSrcSel = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL3 & (0x7ul << (8))) >> (8);

        u32UartClkDivNum = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKDIV4 & (0xful << (16))) >> (16);
    }
    else if(uart==(UART_T*)((UART_T *) ((( uint32_t)0x40000000) + 0x77000)))
    {

        u32UartClkSrcSel = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL3 & (0x7ul << (12))) >> (12);

        u32UartClkDivNum = (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKDIV4 & (0xful << (20))) >> (20);
    }
    ...
    if (u32UartClkSrcSel == 4ul)
    {
        ...
        if ((uart == (UART_T *)((UART_T *) ((( uint32_t)0x40000000) + 0x70000))) || (uart == (UART_T *)((UART_T *) ((( uint32_t)0x40000000) + 0x72000))) || (uart == (UART_T *)((UART_T *) ((( uint32_t)0x40000000) + 0x74000))) || (uart == (UART_T *)((UART_T *) ((( uint32_t)0x40000000) + 0x76000))))
        {
...
# 312 "../../Library/StdDriver/src/uart.c"
uint32_t UART_Read(UART_T *uart, uint8_t pu8RxBuf[], uint32_t u32ReadBytes)
{
...
# 373 "../../Library/StdDriver/src/uart.c"
void UART_SetLine_Config(UART_T *uart, uint32_t u32baudrate, uint32_t u32data_width, uint32_t u32parity, uint32_t u32stop_bits)
{
    uint32_t u32UartClkSrcSel = 0ul, u32UartClkDivNum = 0ul;
...
# 487 "../../Library/StdDriver/src/uart.c"
void UART_SetTimeoutCnt(UART_T *uart, uint32_t u32TOC)
{
...
# 510 "../../Library/StdDriver/src/uart.c"
void UART_SelectIrDAMode(UART_T *uart, uint32_t u32Buadrate, uint32_t u32Direction)
{
    uint32_t u32UartClkSrcSel = 0ul, u32UartClkDivNum = 0ul;
    uint32_t u32ClkTbl[6ul] = {(32000000UL), 0ul, (32768UL), (48000000UL), 0ul, (38400UL)};
    ...
    else if (uart == ((UART_T *) ((( uint32_t)0x40000000) + 0x73000)))
    {
    ...
    else if (uart == ((UART_T *) ((( uint32_t)0x40000000) + 0x74000)))
    {
    ...
    else if (uart == ((UART_T *) ((( uint32_t)0x40000000) + 0x75000)))
    {
    ...
    else if (uart == ((UART_T *) ((( uint32_t)0x40000000) + 0x76000)))
    {
    ...
    else if (uart == ((UART_T *) ((( uint32_t)0x40000000) + 0x77000)))
    {
...
# 640 "../../Library/StdDriver/src/uart.c"
void UART_SelectRS485Mode(UART_T *uart, uint32_t u32Mode, uint32_t u32Addr)
{
...
# 662 "../../Library/StdDriver/src/uart.c"
uint32_t UART_Write(UART_T *uart, uint8_t pu8TxBuf[], uint32_t u32WriteBytes)
{
    uint32_t u32Count, u32delayno;
    uint32_t u32Exit = 0ul;
...
# 704 "../../Library/StdDriver/src/uart.c"
void UART_SelectSingleWireMode(UART_T *uart)
{
