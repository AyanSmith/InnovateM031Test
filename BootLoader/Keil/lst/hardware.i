...
# 5 "../Header\\Hardware.h" 2

void DelayMS(volatile uint32_t nTime);
void SYS_Init(void);
# 3 "../Source/Hardware.c" 2
...
void SYS_Init(void)
{
    ...
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPB_MFPH = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPB_MFPH & ~((0xful << (16)) | (0xful << (20)))) | ((0x06UL<<(16)) | (0x06UL<<(20)));
