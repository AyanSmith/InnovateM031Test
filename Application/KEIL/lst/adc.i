# 1 "../../Library/StdDriver/src/adc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 349 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../Library/StdDriver/src/adc.c" 2
# 12 "../../Library/StdDriver/src/adc.c"
...
# 13 "../../Library/StdDriver/src/adc.c" 2
# 22 "../../Library/StdDriver/src/adc.c"
int32_t g_ADC_i32ErrCode = 0;
# 47 "../../Library/StdDriver/src/adc.c"
void ADC_Open(ADC_T *adc,
              uint32_t u32InputMode,
              uint32_t u32OpMode,
              uint32_t u32ChMask)
{
    ...
    if ((adc->ADCALSTSR & (0x1ul << (0))) == 0)
    {

        adc->ADCR |= (0x1ul << (12));
        while((adc->ADCR & (0x1ul << (12))) == (0x1ul << (12)))
        {
            if (--u32Delay == 0)
            {
                g_ADC_i32ErrCode = (-1);
        ...
        adc->ADCALSTSR |= (0x1ul << (0));
        adc->ADCALR |= (0x1ul << (0));
        ((adc)->ADCR |= (0x1ul << (11)));
        u32Delay = SystemCoreClock;
        while((adc->ADCALSTSR & (0x1ul << (0))) != (0x1ul << (0)))
        {
            if (--u32Delay == 0)
            {
                g_ADC_i32ErrCode = (-1);
    ...
    adc->ADCR = (adc->ADCR & (~((0x1ul << (10)) | (0x3ul << (2))))) | (u32InputMode) | (u32OpMode);



    adc->ADCHER = (adc->ADCHER & ~(0xfffffffful << (0))) | (u32ChMask);
...
void ADC_Close(ADC_T *adc)
{
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->IPRST1 |= (0x1ul << (28));
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->IPRST1 &= ~(0x1ul << (28));
    return;
}
# 123 "../../Library/StdDriver/src/adc.c"
void ADC_EnableHWTrigger(ADC_T *adc,
                         uint32_t u32Source,
                         uint32_t u32Param)
{
    if(u32Source == (0UL<<(4)))
    {
        adc->ADCR = (adc->ADCR & ~((0x3ul << (4)) | (0x3ul << (6)) | (0x1ul << (8)))) |
                    ((u32Source) | (u32Param) | (0x1ul << (8)));
    }
    else if(u32Source == (1UL<<(4)))
    {
        adc->ADCR = (adc->ADCR & ~((0x3ul << (4)) | (0x3ul << (6)) | (0x1ul << (8)))) |
                    ((u32Source) | (0x1ul << (8)));
    }
...
void ADC_DisableHWTrigger(ADC_T *adc)
{
    adc->ADCR &= ~((0x3ul << (4)) | (0x3ul << (6)) | (0x1ul << (8)));
    return;
}
# 167 "../../Library/StdDriver/src/adc.c"
void ADC_EnableInt(ADC_T *adc, uint32_t u32Mask)
{
    if((u32Mask) & ((0x1ul << (0))))
        adc->ADCR |= (0x1ul << (1));
    if((u32Mask) & ((0x1ul << (1))))
        adc->ADCMPR[0] |= (0x1ul << (1));
    if((u32Mask) & ((0x1ul << (2))))
        adc->ADCMPR[1] |= (0x1ul << (1));

    return;
}
# 190 "../../Library/StdDriver/src/adc.c"
void ADC_DisableInt(ADC_T *adc, uint32_t u32Mask)
{
    if((u32Mask) & ((0x1ul << (0))))
        adc->ADCR &= ~(0x1ul << (1));
