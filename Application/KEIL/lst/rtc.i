...
# 12 "../../Library/StdDriver/src/rtc.c"
...
# 13 "../../Library/StdDriver/src/rtc.c" 2
# 25 "../../Library/StdDriver/src/rtc.c"
...
void RTC_Open(S_RTC_TIME_DATA_T *psPt)
{
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->INIT = 0xA5EB1357UL;

    if (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->INIT != (0x1ul << (0)))
    {
        ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->INIT = 0xA5EB1357UL;

        while (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->INIT != (0x1ul << (0)))
        {
        }
    }
...
# 100 "../../Library/StdDriver/src/rtc.c"
void RTC_Close(void)
{
    ((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->APBCLK0 &= ~(0x1ul << (1));
}
# 113 "../../Library/StdDriver/src/rtc.c"
void RTC_32KCalibration(int32_t i32FrequencyX10000)
{
    ...
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->FREQADJ = (uint32_t)u32Compensate;
}
# 175 "../../Library/StdDriver/src/rtc.c"
void RTC_GetDateAndTime(S_RTC_TIME_DATA_T *psPt)
{
    uint32_t u32Tmp;

    psPt->u32TimeScale = ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CLKFMT & (0x1ul << (0));
    psPt->u32DayOfWeek = ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->WEEKDAY & (0x7ul << (0));


    g_u32HiYear = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CAL & (0xful << (20))) >> (20);
    g_u32LoYear = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CAL & (0xful << (16))) >> (16);
    g_u32HiMonth = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CAL & (0x1ul << (12))) >> (12);
    g_u32LoMonth = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CAL & (0xful << (8))) >> (8);
    g_u32HiDay = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CAL & (0x3ul << (4))) >> (4);
    g_u32LoDay = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CAL & (0xful << (0))) >> (0);


    g_u32HiHour = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TIME & (0x3ul << (20))) >> (20);
    g_u32LoHour = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TIME & (0xful << (16))) >> (16);
    g_u32HiMin = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TIME & (0x7ul << (12))) >> (12);
    g_u32LoMin = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TIME & (0xful << (8))) >> (8);
    g_u32HiSec = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TIME & (0x7ul << (4))) >> (4);
    g_u32LoSec = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TIME & (0xful << (0))) >> (0);
...
# 270 "../../Library/StdDriver/src/rtc.c"
void RTC_GetAlarmDateAndTime(S_RTC_TIME_DATA_T *psPt)
{
    uint32_t u32Tmp;
    ...
    g_u32HiYear = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CALM & (0xful << (20))) >> (20);
    g_u32LoYear = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CALM & (0xful << (16))) >> (16);
    g_u32HiMonth = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CALM & (0x1ul << (12))) >> (12);
    g_u32LoMonth = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CALM & (0xful << (8))) >> (8);
    g_u32HiDay = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CALM & (0x3ul << (4))) >> (4);
    g_u32LoDay = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CALM & (0xful << (0))) >> (0);


    g_u32HiHour = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TALM & (0x3ul << (20))) >> (20);
    g_u32LoHour = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TALM & (0xful << (16))) >> (16);
    g_u32HiMin = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TALM & (0x7ul << (12))) >> (12);
    g_u32LoMin = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TALM & (0xful << (8))) >> (8);
    g_u32HiSec = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TALM & (0x7ul << (4))) >> (4);
    g_u32LoSec = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TALM & (0xful << (0))) >> (0);
...
# 368 "../../Library/StdDriver/src/rtc.c"
void RTC_SetDateAndTime(S_RTC_TIME_DATA_T *psPt)
{
    ...
    else
    {
        ...
        if (psPt->u32TimeScale == 0UL)
        {
            ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CLKFMT &= ~(0x1ul << (0));
        ...
        ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->WEEKDAY = psPt->u32DayOfWeek;
        ...
        ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CAL = (uint32_t)u32RegCAL;
        ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TIME = (uint32_t)u32RegTIME;
    }
}
...
void RTC_SetAlarmDateAndTime(S_RTC_TIME_DATA_T *psPt)
{
    ...
    else
    {
        ...
        ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CALM = (uint32_t)u32RegCALM;
        ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TALM = (uint32_t)u32RegTALM;
    }
}
# 516 "../../Library/StdDriver/src/rtc.c"
void RTC_SetDate(uint32_t u32Year, uint32_t u32Month, uint32_t u32Day, uint32_t u32DayOfWeek)
{
    uint32_t u32RegCAL;
    ...
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->WEEKDAY = u32DayOfWeek & (0x7ul << (0));


    ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CAL = (uint32_t)u32RegCAL;
}
# 547 "../../Library/StdDriver/src/rtc.c"
void RTC_SetTime(uint32_t u32Hour, uint32_t u32Minute, uint32_t u32Second, uint32_t u32TimeMode, uint32_t u32AmPm)
{
    uint32_t u32RegTIME;
...
# 590 "../../Library/StdDriver/src/rtc.c"
void RTC_SetAlarmDate(uint32_t u32Year, uint32_t u32Month, uint32_t u32Day)
{
    uint32_t u32RegCALM;
...
# 618 "../../Library/StdDriver/src/rtc.c"
void RTC_SetAlarmTime(uint32_t u32Hour, uint32_t u32Minute, uint32_t u32Second, uint32_t u32TimeMode, uint32_t u32AmPm)
{
    uint32_t u32RegTALM;
...
# 665 "../../Library/StdDriver/src/rtc.c"
void RTC_SetAlarmDateMask(uint8_t u8IsTenYMsk, uint8_t u8IsYMsk, uint8_t u8IsTenMMsk, uint8_t u8IsMMsk, uint8_t u8IsTenDMsk, uint8_t u8IsDMsk)
{
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->CAMSK = ((uint32_t)u8IsTenYMsk << (5)) |
                 ((uint32_t)u8IsYMsk << (4)) |
...
# 689 "../../Library/StdDriver/src/rtc.c"
void RTC_SetAlarmTimeMask(uint8_t u8IsTenHMsk, uint8_t u8IsHMsk, uint8_t u8IsTenMMsk, uint8_t u8IsMMsk, uint8_t u8IsTenSMsk, uint8_t u8IsSMsk)
{
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TAMSK = ((uint32_t)u8IsTenHMsk << (5)) |
                 ((uint32_t)u8IsHMsk << (4)) |
                 ((uint32_t)u8IsTenMMsk << (3)) |
                 ((uint32_t)u8IsMMsk << (2)) |
...
# 714 "../../Library/StdDriver/src/rtc.c"
uint32_t RTC_GetDayOfWeek(void)
{
    return (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->WEEKDAY & (0x7ul << (0)));
}
# 737 "../../Library/StdDriver/src/rtc.c"
void RTC_SetTickPeriod(uint32_t u32TickSelection)
{
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TICK = (((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->TICK & ~(0x7ul << (0))) | u32TickSelection;
}
# 753 "../../Library/StdDriver/src/rtc.c"
void RTC_EnableInt(uint32_t u32IntFlagMask)
{
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->INTEN |= u32IntFlagMask;
}
# 769 "../../Library/StdDriver/src/rtc.c"
void RTC_DisableInt(uint32_t u32IntFlagMask)
{
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->INTEN &= ~u32IntFlagMask;
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x41000))->INTSTS = u32IntFlagMask;
}
