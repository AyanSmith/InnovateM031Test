...
static void EMeterLowLevelInit(void)
{
 SYS_ResetModule(((0x4<<24)|(17)));
 UART_Open(((UART_T *) ((( uint32_t)0x40000000) + 0x71000)), 2400);
 NVIC_EnableIRQ(UART13_IRQn);
  UART_EnableInt(((UART_T *) ((( uint32_t)0x40000000) + 0x71000)), ((0x1ul << (0)) ));
}
...
void UART13_IRQHandler(void)
{
 ...
 if ((((((UART_T *) ((( uint32_t)0x40000000) + 0x71000)))->INTSTS & ((0x1ul << (8))))?1:0))
 {
  while((((((UART_T *) ((( uint32_t)0x40000000) + 0x71000)))->INTSTS & (0x1ul << (0)))>>(0)))
    {
   u8InChar = ((((UART_T *) ((( uint32_t)0x40000000) + 0x71000)))->DAT);
   recevBuff[fillBytes++]=u8InChar;
   if(fillBytes > (512-5))
    fillBytes = 0;
  }
 }
...
void UpdateMeterMaxwell3P(void)
{
 ...
 MeterParam.RPhase.Amp=0;
 MeterParam.RPhase.Volt=0;
 MeterParam.YPhase.Amp=0;
 MeterParam.YPhase.Volt=0;
 MeterParam.BPhase.Amp=0;
 MeterParam.BPhase.Volt=0;

 sendBytes[0]=0xCC;
 sendBytes[1]=0x91;
 sendBytes[2]=0xDD;

 memset(recevBuff, 0x00, 300);
 fillBytes = 0;

 for(i=0; i<3; i++)
  {
  while((((((UART_T *) ((( uint32_t)0x40000000) + 0x71000)))->FIFOSTS & (0x1ul << (23)))>>(23)));
  ((((UART_T *) ((( uint32_t)0x40000000) + 0x71000)))->DAT = (sendBytes[i]));
  }
 j = 0;
 while((fillBytes < 65) && (j < (PeriPheralVal.MeterTimeout/5)))
 {
  j++;
  Delay(5);
 }
 ...
 if(fillBytes > 63)
 {
   if((recevBuff[0] == 0xCC) && (recevBuff[2] == 0xDD))
    m=3;
   else
    m=0;
   IntToChar.chr[0]=recevBuff[1 + m];
   IntToChar.chr[1]=recevBuff[0 + m];
   IntToChar.chr[2]=0;
   IntToChar.chr[3]=0;
   MeterParam.RPhase.Volt=IntToChar.IntVal;
   IntToChar.chr[0]=recevBuff[3 + m];
   IntToChar.chr[1]=recevBuff[2 + m];
   MeterParam.YPhase.Volt=IntToChar.IntVal;
   IntToChar.chr[0]=recevBuff[5 + m];
   IntToChar.chr[1]=recevBuff[4 + m];
   MeterParam.BPhase.Volt=IntToChar.IntVal;
   IntToChar.chr[0]=recevBuff[7 + m];
   IntToChar.chr[1]=recevBuff[6 + m];
   MeterParam.RPhase.Amp=IntToChar.IntVal;
   IntToChar.chr[0]=recevBuff[9 + m];
   IntToChar.chr[1]=recevBuff[8 + m];
   MeterParam.YPhase.Amp=IntToChar.IntVal;
   IntToChar.chr[0]=recevBuff[11 + m];
   IntToChar.chr[1]=recevBuff[10 + m];
   MeterParam.BPhase.Amp=IntToChar.IntVal;

   MeterParam.RPhase.mPF=recevBuff[12 + m];
   MeterParam.YPhase.mPF=recevBuff[13 + m];
   MeterParam.BPhase.mPF=recevBuff[14 + m];

   IntToChar.chr[0]=recevBuff[17 + m];
   IntToChar.chr[1]=recevBuff[16 + m];
   IntToChar.chr[2]=recevBuff[15 + m];
   MeterParam.RPhase.kW=IntToChar.IntVal;

   IntToChar.chr[0]=recevBuff[20 + m];
   IntToChar.chr[1]=recevBuff[19 + m];
   IntToChar.chr[2]=recevBuff[18 + m];
   MeterParam.YPhase.kW=IntToChar.IntVal;

   IntToChar.chr[0]=recevBuff[23 + m];
   IntToChar.chr[1]=recevBuff[22 + m];
   IntToChar.chr[2]=recevBuff[21 + m];
   MeterParam.BPhase.kW=IntToChar.IntVal;

   IntToChar.chr[0]=recevBuff[26 + m];
   IntToChar.chr[1]=recevBuff[25 + m];
   IntToChar.chr[2]=recevBuff[24 + m];
   MeterParam.RPhase.kVA=IntToChar.IntVal;

   IntToChar.chr[0]=recevBuff[29 + m];
   IntToChar.chr[1]=recevBuff[28 + m];
   IntToChar.chr[2]=recevBuff[27 + m];
   MeterParam.YPhase.kVA=IntToChar.IntVal;

   IntToChar.chr[0]=recevBuff[32 + m];
   IntToChar.chr[1]=recevBuff[31 + m];
   IntToChar.chr[2]=recevBuff[30 + m];
   MeterParam.BPhase.kVA=IntToChar.IntVal;

   IntToChar.chr[0]=recevBuff[35 + m];
   IntToChar.chr[1]=recevBuff[34 + m];
   IntToChar.chr[2]=recevBuff[33 + m];
   MeterParam.RPhase.kVAr=IntToChar.IntVal;

   IntToChar.chr[0]=recevBuff[38 + m];
   IntToChar.chr[1]=recevBuff[37 + m];
   IntToChar.chr[2]=recevBuff[36 + m];
   MeterParam.YPhase.kVAr=IntToChar.IntVal;

   IntToChar.chr[0]=recevBuff[41 + m];
   IntToChar.chr[1]=recevBuff[40 + m];
   IntToChar.chr[2]=recevBuff[39 + m];
   MeterParam.BPhase.kVAr=IntToChar.IntVal;

   IntToChar.chr[0]=recevBuff[44 + m];
   IntToChar.chr[1]=recevBuff[43 + m];
   IntToChar.chr[2]=recevBuff[42 + m];
   MeterParam.TotalKWH=IntToChar.IntVal;

   IntToChar.chr[0]=recevBuff[47 + m];
   IntToChar.chr[1]=recevBuff[46 + m];
   IntToChar.chr[2]=recevBuff[45 + m];
   MeterParam.TotalKVAH=IntToChar.IntVal;

   IntToChar.chr[0]=recevBuff[68 + m];
   IntToChar.chr[1]=recevBuff[67 + m];
   MeterParam.Freq=IntToChar.IntVal;
   MeterParam.IsMeter = 1;
   MeterParam.MeterType = 1;
 }
...
# 287 "../Source/EMeter.c"
uint8_t CheckMeter(void)
{

 UpdateMeterMaxwell3P();
...
void ProcessMeter(void)
{
 if(MeterParam.IsMeter)
 {
  MeterParam.IsMeter = 0;

  if(MeterParam.MeterType==1)
   UpdateMeterMaxwell3P();
