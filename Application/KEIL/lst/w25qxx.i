...
{
 SPI_Open(((SPI_T *) ((( uint32_t)0x40000000) + 0x61000)), (0x0ul), ((0x1ul << (2))), 8, 1000000);
 GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) )), (0x00000008UL), 0x1UL);
...
unsigned char SPI_FLASH_SendByte(unsigned char byte)
{
 ...
 while(((((((SPI_T *) ((( uint32_t)0x40000000) + 0x61000)))->STATUS & (0x1ul << (17)))>>(17))));
 ((((SPI_T *) ((( uint32_t)0x40000000) + 0x61000)))->TX = (byte));

 while((((((SPI_T *) ((( uint32_t)0x40000000) + 0x61000)))->STATUS & (0x1ul << (8)))>>(8)));
 TempChar = ((SPI_T *) ((( uint32_t)0x40000000) + 0x61000))->RX;
 rt = TempChar;
 return rt;
}
...
uint8_t W25Q_Write(unsigned char *pucBuffer, unsigned long ulWriteAddr, unsigned long ulNumByteToWrite)
{
 ...
 uint16_t i;
 if(ulWriteAddr >= 0x100 * 0x2000) return 0;
