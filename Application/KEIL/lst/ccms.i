...
double m_SunSet, m_SunRise;
double JD;
void GetScheduleStat(void);
extern double curLatitude, curLongitude;

void LED0_Set(uint16_t TotalTime, uint16_t OnTime)
{
 LedState.TotalTime=TotalTime;
 LedState.ONTime= OnTime;
}
...
void LatchON(void)
{
 (*((volatile uint32_t *)(((((( uint32_t)0x40000000) + 0x4000) + 0x0800)+(0x40*(2))) + ((4)<<2)))) = 1;
 Delay(1500);
 (*((volatile uint32_t *)(((((( uint32_t)0x40000000) + 0x4000) + 0x0800)+(0x40*(2))) + ((4)<<2)))) = 0;
 CCMS.CCMSState |= 0x01;
...
void LatchOff(void)
{
 ...
 (*((volatile uint32_t *)(((((( uint32_t)0x40000000) + 0x4000) + 0x0800)+(0x40*(2))) + ((3)<<2)))) = 1;
 Delay(1500);
 (*((volatile uint32_t *)(((((( uint32_t)0x40000000) + 0x4000) + 0x0800)+(0x40*(2))) + ((3)<<2)))) = 0;
 CCMS.CCMSState &= ~0x01;
...
void GetScheduleStat(void)
{
 ...
 if(!IsTimeSet)
  return;
 if((CCMS.CCMSControl & 0x02) && ((CCMS.CCMSControl & 0x04) == 0))
 {
  tM = (CCMS.Schedule.OffTime.Hour*60) + CCMS.Schedule.OffTime.Min;
  tE = (CCMS.Schedule.OnTime.Hour*60) + CCMS.Schedule.OnTime.Min;
  if(IsRTC)
   cT = (RTCDateTime.Hour * 60) + RTCDateTime.Min;
  else
   cT = (CurrentDateTime.Hour * 60) + CurrentDateTime.Min;
...
void GetAstroSchedule(void)
{
 uint16_t cT;
 if((CCMS.CCMSControl & 0x40) && (!(CCMS.CCMSControl & 0x02)) && (!(CCMS.CCMSControl & 0x04)))
 {
  JD=calcJD(CurrentDateTime.Year,CurrentDateTime.Month,CurrentDateTime.Date);
  m_SunRise=calcSunriseUTC(JD,curLatitude,curLongitude);
  m_SunSet=calcSunsetUTC(JD,curLatitude,curLongitude);
  cT = (CurrentDateTime.Hour * 60) + CurrentDateTime.Min;
  if((cT > m_SunRise) && (cT < m_SunSet))
  {
   (*((volatile uint32_t *)(((((( uint32_t)0x40000000) + 0x4000) + 0x0800)+(0x40*(2))) + ((4)<<2))))=0;(*((volatile uint32_t *)(((((( uint32_t)0x40000000) + 0x4000) + 0x0800)+(0x40*(2))) + ((3)<<2))))=0;(*((volatile uint32_t *)(((((( uint32_t)0x40000000) + 0x4000) + 0x0800)+(0x40*(2))) + ((2)<<2))))=0;(*((volatile uint32_t *)(((((( uint32_t)0x40000000) + 0x4000) + 0x0800)+(0x40*(2))) + ((5)<<2))))=0;CCMS.CCMSState&=(~0x01);
   LatchOff();
   CCMS.CCMSState &= ~0x40;
